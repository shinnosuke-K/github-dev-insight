...
func (prd *PullRequestDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, PullRequestMutation](ctx, prd.sqlExec, prd.mutation, prd.hooks)
}
...
func (prd *PullRequestDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(pullrequest.Table, sqlgraph.NewFieldSpec(pullrequest.FieldID, field.TypeUUID))

...
func (cc *CommitsCreate) Save(ctx context.Context) (*Commits, error) {
	cc.defaults()
	return withHooks[*Commits, CommitsMutation](ctx, cc.sqlSave, cc.mutation, cc.hooks)
}
...
func (cc *CommitsCreate) check() error {
	if _, ok := cc.mutation.GithubID(); !ok {
		return &ValidationError{Name: "github_id", err: errors.New(`ent: missing required field "Commits.github_id"`)}
	}
	...
	if _, ok := cc.mutation.Message(); !ok {
		return &ValidationError{Name: "message", err: errors.New(`ent: missing required field "Commits.message"`)}
	}
	if _, ok := cc.mutation.Additions(); !ok {
		return &ValidationError{Name: "additions", err: errors.New(`ent: missing required field "Commits.additions"`)}
	}
	if _, ok := cc.mutation.Deletions(); !ok {
		return &ValidationError{Name: "deletions", err: errors.New(`ent: missing required field "Commits.deletions"`)}
	}
	if _, ok := cc.mutation.ChangeFiles(); !ok {
		return &ValidationError{Name: "change_files", err: errors.New(`ent: missing required field "Commits.change_files"`)}
	}
	if _, ok := cc.mutation.CommittedAt(); !ok {
		return &ValidationError{Name: "committed_at", err: errors.New(`ent: missing required field "Commits.committed_at"`)}
	}
	return nil
}
...
func (cc *CommitsCreate) createSpec() (*Commits, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(commits.Table, sqlgraph.NewFieldSpec(commits.FieldID, field.TypeUUID))
	)

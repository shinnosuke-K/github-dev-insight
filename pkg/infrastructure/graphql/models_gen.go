...
type ContributionsCollection struct {
	...
	ContributionYears []int64 `json:"contributionYears,omitempty"`
...
type DependencyGraphManifest struct {
	...
	DependenciesCount *int64 `json:"dependenciesCount,omitempty"`
...
type Team struct {
	...
	ReviewRequestDelegationMemberCount *int64 `json:"reviewRequestDelegationMemberCount,omitempty"`
...
func (e FundingPlatform) IsValid() bool {
	switch e {
	case FundingPlatformCommunityBridge, FundingPlatformCustom, FundingPlatformGithub, FundingPlatformIssuehunt, FundingPlatformKoFi, FundingPlatformLiberapay, FundingPlatformOpenCollective, FundingPlatformOtechie, FundingPlatformPatreon, FundingPlatformTidelift:
		return true
	}
	return false
}
